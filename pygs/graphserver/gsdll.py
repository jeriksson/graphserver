...
pycapi(lgs.makeUrbanExplorerBlob, c_void_p, [c_void_p, c_char_p, c_char_p, c_void_p, c_void_p, c_void_p])
...
pycapi(lgs.haGetWheelchairBoarding, c_int, [c_void_p])
...
pycapi(lgs.haNew, c_void_p, [c_int, c_void_p, c_void_p, c_int, c_int, c_int, c_char_p, c_int, c_int, c_int])

# HEADWAY BOARD API
pycapi(lgs.hbDestroy, c_void_p, [c_void_p])
pycapi(lgs.hbGetAgency, c_int, [c_void_p])
pycapi(lgs.hbGetRouteType, c_int, [c_void_p])
pycapi(lgs.hbGetWheelchairBoarding, c_int, [c_void_p])
...
pycapi(lgs.hbNew, c_void_p, [c_int, c_void_p, c_void_p, c_int, c_int, c_int, c_char_p, c_int, c_int, c_int])

# TRIPBOARD API
pycapi(lgs.tbNew, c_void_p, [c_int, c_void_p, c_void_p, c_int, c_int, c_int])
...
pycapi(lgs.tbGetWheelchairBoarding, c_int, [c_void_p])
...
pycapi(lgs.alGetWheelchairBoarding, c_int, [c_void_p])
pycapi(lgs.alGetServiceId, c_int, [c_void_p])
pycapi(lgs.alGetTimezone, c_void_p, [c_void_p])
pycapi(lgs.alNew, c_void_p, [c_int, c_void_p, c_void_p, c_int, c_int, c_int])

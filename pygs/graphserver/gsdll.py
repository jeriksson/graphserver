...
#ADDITIONAL LGS API DEFINITIONS
...
pycapi(lgs.haNew, c_void_p, [c_int, c_void_p, c_void_p, c_int, c_char_p, c_int, c_int, c_int])
...
pycapi(lgs.hbNew, c_void_p, [c_int, c_void_p, c_void_p, c_int, c_char_p, c_int, c_int, c_int])
